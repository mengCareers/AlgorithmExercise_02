...
public class CutOffTreesForGolfEvent {
    public static void main(String[] args) {
        ...
        forest.add(Arrays.asList(new Integer[]{54581641, 64080174, 24346381, 69107959}));
        forest.add(Arrays.asList(new Integer[]{86374198, 61363882, 68783324, 79706116}));
        forest.add(Arrays.asList(new Integer[]{668150, 92178815, 89819108, 94701471}));
        forest.add(Arrays.asList(new Integer[]{83920491, 22724204, 46281641, 47531096}));
        forest.add(Arrays.asList(new Integer[]{89078499, 18904913, 25462145, 60813308}));
